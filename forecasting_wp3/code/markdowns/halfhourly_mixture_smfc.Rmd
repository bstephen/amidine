...
<!-- hh_agg_eval_rel$blend <- rbindlist(ml_eval_mods(mod_list = hh_agg_models$blend, -->
<!--                                                 metric = "rel", -->
<!--                                                 melted_dt = lcl_data[aggregation!="sm"], -->
<!--                                                 obs_col = "demand", -->
<!--                                                 split_col = "id", -->
...
<!-- hh_agg_eval_rel$blend_opt <- rbindlist(ml_eval_mods(mod_list = hh_agg_models$blend_opt, -->
<!--                                                     metric = "rel", -->
<!--                                                     melted_dt = lcl_data[aggregation!="sm"], -->
<!--                                                     obs_col = "demand", -->
<!--                                                     split_col = "id", -->
...
<!-- hh_agg_eval_rel$blend_opthh <- rbindlist(ml_eval_mods(mod_list = hh_agg_models$blend_opthh, -->
<!--                                                       metric = "rel", -->
<!--                                                       melted_dt = lcl_data[aggregation!="sm"], -->
<!--                                                       obs_col = "demand", -->
<!--                                                       split_col = "id", -->
...
<!-- temprel <- rbindlist(hh_agg_eval_rel,idcol = "model") -->
<!-- temp <- unique(lcl_data[aggregation!="sm",.(id,aggregation,fdr_id,ss_id)]) -->
<!-- temprel <- temprel[temp,on=.(id)] -->
<!-- temprel[,model:= factor(model,names(hh_agg_eval_rel))] -->


<!-- ggplot(data=temprel[model%in%c("bench","m8","blend","blend_opt","blend_opthh") & kfold%in%c("All_cv","Test")], -->
<!--        aes(x=Nominal)) + -->
