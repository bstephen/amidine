...
- binomial family, rather than poisson is better as well (not shown)
...
- also we only have a only year to learn the day-of-year seasonal and interaction effect, but it's obviously very important.
