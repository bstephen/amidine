...
<!-- ggplot(data=lcl_data[aggregation!="sm"],aes(y=demand,x=demandpk_l1d))+ -->
<!--   labs(y = "demand [kWh]",x = "demand lag 1d [kWh]")+ -->
<!--   geom_point(size=0.1,colour="steelblue",alpha=.5)+ -->
<!--   facet_wrap(~aggregation,nrow=1,scales = "free") -->
...
- Generally, the skill score magnitudes reduce as you go down the voltage levels as demand befomes less smooth and more difficult to predict
